...
/* SQLINES DEMO *** abase [HealthcareSystem]    Script Date: 17-Oct-21 8:08:49 PM ******/
...
/* SQLINES DEMO *** le [dbo].[Accounts]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Appointments]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Blogs]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Doctor_Feedbacks]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Doctors]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Patients]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Reservations]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Service_Feedbacks]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Services]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Specialities]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
/* SQLINES DEMO *** le [dbo].[Timetable]    Script Date: 17-Oct-21 8:08:50 PM ******/
/* SET ANSI_NULLS ON */
...
GO
INSERT Specialities (`type_id`, `name`) VALUES (1, N'Anesthetics & Recovery ');
 
INSERT Specialities (`type_id`, `name`) VALUES (2, N'Autism & Cerebral Palsy ');
 
INSERT Specialities (`type_id`, `name`) VALUES (3, N'Beauty ');
 
INSERT Specialities (`type_id`, `name`) VALUES (4, N'Cardiology ');
 
INSERT Specialities (`type_id`, `name`) VALUES (5, N'Dentistry');
 
INSERT Specialities (`type_id`, `name`) VALUES (6, N'Dermatology');
 
INSERT Specialities (`type_id`, `name`) VALUES (7, N'Endocrinology');
 
INSERT Specialities (`type_id`, `name`) VALUES (8, N'Fertility');
 
INSERT Specialities (`type_id`, `name`) VALUES (9, N'Gastroenterology');
 
INSERT Specialities (`type_id`, `name`) VALUES (10, N'Gynecology & Obstetrics');
 
INSERT Specialities (`type_id`, `name`) VALUES (11, N'Hematology & Blood Transfusion');
 
INSERT Specialities (`type_id`, `name`) VALUES (12, N'Infectious Disease');
 
INSERT Specialities (`type_id`, `name`) VALUES (13, N'Neurology');
 
INSERT Specialities (`type_id`, `name`) VALUES (14, N'Nutrition');
 
INSERT Specialities (`type_id`, `name`) VALUES (15, N'Oncology');
 
INSERT Specialities (`type_id`, `name`) VALUES (16, N'Ophthalmology');
 
INSERT Specialities (`type_id`, `name`) VALUES (17, N'Orthopedic');
 
INSERT Specialities (`type_id`, `name`) VALUES (18, N'Pediatrics');
 
INSERT Specialities (`type_id`, `name`) VALUES (19, N'Pharmacy');
 
INSERT Specialities (`type_id`, `name`) VALUES (20, N'Physical Therapy & Rehabilitation ');
 
INSERT Specialities (`type_id`, `name`) VALUES (21, N'Resuscitation & Emergency');
 

SET IDENTITY_INSERT `dbo`.`Timetable` ON 
GO
INSERT Timetable (`slot_id`, `time`) VALUES (1, N'7h - 8h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (2, N'8h - 9h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (3, N'9h - 10h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (4, N'10h -11h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (5, N'11h - 12h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (6, N'14h - 15h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (7, N'15h - 16h');
 
INSERT Timetable (`slot_id`, `time`) VALUES (8, N'16h -17h');
 

SET IDENTITY_INSERT `dbo`.`Blogs` ON 
INSERT [dbo].[Blogs] (`blog_id`, `title`, `date`, `image`, `description`) 
SELECT (1, N'Percutaneous heart valve replacement', CAST(N'2020-05-17' AS Date), N'https://vinmec-prod.s3.amazonaws.com/images/20190426_040437_971221_hep-ho-van-dong-mac.max-1800x1800.jpg', 
...
INSERT Blogs (`blog_id`, `title`, `date`, `image`, `description`) 
...
/* SQLINES DEMO *** ex [UQ__Accounts__F3DBC57239A94B73]    Script Date: 17-Oct-21 8:08:50 PM ******/
...
ALTER TABLE Appointments  ADD FOREIGN KEY(`slot_id`)
REFERENCES Timetable (`slot_id`);
 
ALTER TABLE Doctor_Feedbacks  ADD FOREIGN KEY(`doctor_id`)
REFERENCES Doctors (`doctor_id`);
 
ALTER TABLE Doctor_Feedbacks  ADD FOREIGN KEY(`patient_id`)
REFERENCES Patients (`patient_id`);
 
ALTER TABLE Doctors  ADD FOREIGN KEY(`account_id`)
REFERENCES Accounts (`account_id`);
 
ALTER TABLE Doctors  ADD FOREIGN KEY(`type_id`)
REFERENCES Specialities (`type_id`);
 
ALTER TABLE Patients  ADD FOREIGN KEY(`account_id`)
REFERENCES Accounts (`account_id`);
 
ALTER TABLE Reservations  ADD FOREIGN KEY(`patient_id`)
REFERENCES Patients (`patient_id`);
 
ALTER TABLE Reservations  ADD FOREIGN KEY(`service_id`)
REFERENCES Services (`service_id`);
 
ALTER TABLE Reservations  ADD  CONSTRAINT `FK_Reservations_Timetable` FOREIGN KEY(`slot_id`)
REFERENCES Timetable (`slot_id`);
 
ALTER TABLE Reservations CHECK CONSTRAINT [FK_Reservations_Timetable];
 
ALTER TABLE Service_Feedbacks  ADD FOREIGN KEY(`patient_id`)
REFERENCES Patients (`patient_id`);
 
ALTER TABLE Service_Feedbacks  ADD FOREIGN KEY(`service_id`)
REFERENCES Services (`service_id`);
 
ALTER TABLE Services  ADD FOREIGN KEY(`type_id`)
REFERENCES Specialities (`type_id`);
 
ALTER TABLE Doctors  ADD CHECK  ((NOT `phone` like '%[^0-9]%' AND char_length(rtrim(`phone`))>=(8) AND char_length(rtrim(`phone`))<=(10)));
 
ALTER TABLE Patients  ADD CHECK  ((NOT `phone` like '%[^0-9]%' AND char_length(rtrim(`phone`))>=(8) AND char_length(rtrim(`phone`))<=(10)));
