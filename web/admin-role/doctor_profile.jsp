            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Profile Dr.${doctor.name}</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="admin-home">Dashboard</a></li>
                                                                        <li class="breadcrumb-item"><a href="doctor_list">Doctor List</a></li>
						...
						<div class="col-md-12">
							...
							<div class="profile-menu">
								<ul class="nav nav-tabs nav-tabs-solid">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#password_tab">Appointment</a>
									</li>
                                                                        <li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#feedback_tab">Doctor Feedback</a>
									</li>
								</ul>
							</div>	
