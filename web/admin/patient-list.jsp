    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${listUsers}" var="user">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="actions">
                                                                    <a class="btn btn-sm bg-success-light" data-toggle="modal" href="#edit_specialities_details_update" >
                                                                        <i class="fe fe-pencil"></i> Edit
                                                                    </a>
                                                                    <a  href="delete?id=${user.userID}" class="btn btn-sm bg-danger-light">
                ...
                <!-- Edit Details Modal -->
                <div class="modal fade" id="edit_specialities_details_update" aria-hidden="true" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="edit" method="post">
                                    <div class="row form-row">
                                        <div class="col-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" value="${userModal.name}" name="name">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">    
                                                <label>Gender</label><br>
                                                <c:if test="${userModal.gender == 1}">
                                                    <input type="radio" name="gender" value="Male" checked="" >Male
                                                    <input type="radio" name="gender" value="Female" style=" margin-left: 20px">Female
                                                </c:if>
                                                <c:if test="${user.gender == 0}">
                                                    <input type="radio" name="gender" value="Male"  >Male
                                                    <input type="radio" name="gender" value="Female" checked="" style=" margin-left: 20px">Female
                                                </c:if>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 ">
                                            <div class="form-group ">
                                                <label>DOB</label>
                                                <input type="text " class="form-control " value="${userModal.dob} " name="dob">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 ">
                                            <div class="form-group ">
                                                <label>Phone</label>
                                                <input type="text " class="form-control " value="${userModal.phone} " name="phone">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 ">
                                            <div class="form-group ">
                                                <label>Email</label>
                                                <input type="text " class="form-control " value="${userModal.email}" name="email">
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit " class="btn btn-primary btn-block ">Save Changes</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-content p-2">
                                    ...
                                    <a href="delete?id=${user.userID}"><button type="button" class="btn btn-primary">Save</button></a>
