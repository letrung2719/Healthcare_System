<%-- 
    ...
    Created on : 02-Oct-2021, 18:17:03
    Author     : Admin
--%>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" class="genderedit">
                                                        <option value="${doctor.gender == 0 ? 'Female' : 'Male'}">${doctor.gender == 0 ? 'Female' : 'Male'}</option>
                                                        <option value="${doctor.gender == 0 ? 'Male' : 'Female'}">${doctor.gender == 0 ? 'Male' : 'Female'}</option>                                                        
                                                    </select>  
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input name="dob" type="text" class="form-control" value="${doctor.dob}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
