...
<header class="header">
    <nav class="navbar navbar-expand-lg header-nav">
        ...
        <div class="main-menu-wrapper">
            ...
            <ul class="main-nav">
                <li class="${path == "/doctor/doctor-appointment.jsp" ? "active" : ""}"><a href="doctorAppointmentControl?doctorID=${sessionScope.user.doctorID}&indexPage=1">My Appointments</a></li>
                <li class="${path == "#" ? "active" : ""}"><a href="#">My Patients</a></li>
                <li class="${path == "/doctor/doctor-feedback-list.jsp" ? "active" : ""}"><a href="doctorFeedbackList?doctorID=${sessionScope.user.doctorID}&page=1">My Feedbacks</a></li>
            </ul>
        </div>
